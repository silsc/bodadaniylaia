  ...
  return (
    <div className={`navbar top-0 left-0 right-0 fixed z-10 ${scroll ? "bg-pink" : ""} ease-in duration-300`}>
      <div className='p-5 lg:px-12 lg:pt-6 max-w-7xl m-auto'>
        <div className='navbar-top flex justify-between items-center pb-5'>
          <NavLink className="bg-no-repeat bg-center bg-cover	h-10 w-12" to="/" style={{backgroundImage: `url(${Logo})`}}/>
          <div className=''>
        ...
        <div className='flex px-2.5 pt-3 justify-between border-t-[1px] border-white text-white'>
          ...
          <HashLink smooth to='/#dresscodeSection'  className='hover:text-pink cursor-pointer ease-in duration-300 text-sm/[9px] lg:text-base'>Dresscode</HashLink>
