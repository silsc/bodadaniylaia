...
const PhotosSection = () => {
  return (
    <section id="photosSection" className='max-w-7xl m-auto px-5'>
      <div className='border-y-[1px] sm:px-8 pt-8 sm:pb-20 pb-8'>
        <h2 className='font-sans text-center sm:text-9xl text-7xl sm:pb-8 pb-5'>Álbum de fotos</h2>
        <div className='flex justify-center content-center sm:ml-3 sm:mr-10 sm:px-10 px-3'>
          <p className='sm:mr-7 mr-5 self-center'>Ayúdanos a crear nuestro albúm de fotos.<br></br> Sube las fotos que has sacado durante la boda haciéndo click en la carpeta.</p>
          <a target='_blank' className="sm:basis-auto basis-2/3 cursor-pointer self-center" rel='noopener noreferrer' href="https://mega.nz/filerequest/e7TxBsKJBJM">
